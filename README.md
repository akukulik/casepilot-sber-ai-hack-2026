...
На GitHub Pages включён безопасный статический demo mode: он показывает полный
операторский путь на синтетическом кейсе `VAL-DC-002`, не обращается к
OpenRouter и не расходует API-бюджет. Полноценный агентный режим с Ouroboros,
LLM и всеми runtime-проверками запускается локально по инструкции ниже.
